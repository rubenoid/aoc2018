...
object Day05 extends App:
  ...
  */
  def destroyUnits(s: String)(f: (String, List[String], String) => String, t: List[String], r: String): String =
  ...
  val new_polymer = destroyUnits(polymer)(replaceStrings, table, "")
    ...
    def loop(x: String, acc: List[String], i: Int): List[String] =
      i match
        ...
        case _ =>
          ...
          val tmpNewPol = destroyUnits(tmpPol)(replaceStrings, t, "")
